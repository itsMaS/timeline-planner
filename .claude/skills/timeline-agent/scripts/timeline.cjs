        ...
        switch (c) {
          ...
          case Qa:
            a: {
              ...
              b.blockedSegment = m;
              try {
                if (Jb(a, b, d), a.responseState.generateStaticMarkup || m.lastPushedText && m.textEmbedded && m.chunks.push("<!-- -->"), m.status = 1, X2(h, m), 0 === h.pendingTasks) break a;
              } catch (l) {
...
var SYNC_SCALARS = ["name", "hierarchyLevels", "settings"];
...
function unitSuffix(preset, custom) {
  return preset === "custom" ? custom.trim() : UNIT_SUFFIX[preset] ?? "";
}
function formatTimeLabel(totalSeconds, stepSeconds) {
...
function formatUnit(v, step, suffix, preset = "none") {
...
function itemMatchesFilters(p, it, f) {
...
var Infinity2 = createLucideIcon("Infinity", __iconNode781);
...
// src/model/icons.ts
var ALL_ICON_NAMES = Object.keys(icons_exports);
function iconByName(name) {
  return icons_exports[name] ?? icons_exports.Circle;
}
var RAW_CATEGORIES = {
...
var ICON_CATEGORIES = Object.fromEntries(
  Object.entries(RAW_CATEGORIES).map(([cat, names]) => [
    cat,
    [...new Set(names)].filter((n) => n in icons_exports)
  ])
);
...
function inline(text, keyBase) {
  ...
  while (m = re.exec(text)) {
    ...
    if (m[2]) out.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: m[2] }, `${keyBase}b${k++}`));
    else if (m[4]) out.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: m[4] }, `${keyBase}i${k++}`));
    else if (m[6]) out.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: m[6] }, `${keyBase}c${k++}`));
    else if (m[8]) out.push(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: m[9], target: "_blank", rel: "noreferrer noopener", children: m[8] }, `${keyBase}a${k++}`)
    );
...
function Markdown({ text }) {
  ...
  const flushList = (key) => {
    ...
    blocks.push(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: listBuf.map((li, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: inline(li, `${key}-${i}`) }, i)) }, key)
    );
    listBuf = [];
  };
  lines.forEach((line, i) => {
    ...
    flushList(`l${i}`);
    if (line.trim() === "") return;
    blocks.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: inline(line, `p${i}`) }, `p${i}`));
  });
  flushList("lEnd");
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "md", children: blocks });
}
...
function Heading7({ level, className, children }) {
...
function DocBody({ proj, roots, loose }) {
  ...
  const renderItem = (it, level) => {
    ...
    const fields = (t?.fields ?? []).filter((f) => (it.fieldValues[f.id] ?? "").trim());
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "item", style: { "--c": t?.color ?? "#888" }, children: [
      ...
      fields.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dl", { className: "fields", children: fields.map((f) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dt", { children: f.name }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dd", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Markdown, { text: it.fieldValues[f.id] }) })
      ] }, f.id)) }),
  ...
  const renderSection = (n, level) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: `sec l${level}`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Heading7, { level, className: "sec-h", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "type", children: proj.hierarchyLevels[sc.depth] ?? `Level ${sc.depth + 1}` })
      ] }),
...
function buildDocHTML(proj, sectionIds) {
  ...
  const scope = sectionIds ? `${rootNames.length === 1 ? proj.hierarchyLevels[roots[0].section.depth] ?? "Section" : "Sections"}: ${rootNames.join(", ")}` : "Whole timeline";
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "doc-bar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { children: "Save as PDF" }),
          "."
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { id: "print-btn", children: "Print / Save as PDF" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("header", { className: "cover", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h1", { children: title }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { children: [
          scope,
          " \xB7 ",
          visibility,
          " \xB7 Timeline Planner export, ",
...
// src/sync/client.ts
var SUPABASE_URL = "https://qrkywsxdujxlognlthts.supabase.co";
var SUPABASE_KEY = "sb_publishable_kACkHPr69j5z8IQoMostxg_Ync3Z4If";
var CLIENT_ID = Math.random().toString(36).slice(2, 12);
...
var opt = (k) => typeof opts[k] === "string" ? opts[k] : void 0;
var flag = (k) => opts[k] === true;
...
var TOKEN = () => tokenFromLink(opt("link") ?? process.env.TIMELINE_LINK ?? process.env.TIMELINE_EDIT_LINK);
...
async function cmdPropose() {
  ...
  const notes = opt("notes") ? JSON.parse((0, import_node_fs.readFileSync)(opt("notes"), "utf8")) : {};
  ...
  const p = await rpc("proposal_create", {
    p_edit_token: token,
    p_title: title,
    p_summary: opt("summary") ?? "",
    p_author: opt("author") ?? "Claude",
    p_base_version: base.version || null,
    p_changes: changes
  });
...
async function cmdStatus() {
  const r = await rpc("proposal_list", { p_edit_token: TOKEN(), p_since: null });
  if (!r) fail("this link is not valid (revoked or mistyped)");
  const rows = flag("all") ? r.rows : r.rows.filter((p) => p.status === "open");
  if (!rows.length) {
    console.log(flag("all") ? "no proposals" : "no open proposals");
    return;
  }
  for (const p of rows) {
    let applied = 0;
