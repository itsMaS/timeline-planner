...
export {
  blankProject, DEFAULT_LEVEL_NAMES, defaultSettings, emptyFilters, newLevel, normalizeFilters, normalizeProject,
} from './normalize'
import { blankProject, emptyFilters, normalizeProject } from './normalize'
