 ...
 * fields (name, hierarchyLevels, settings) use col 'project' with the field
...
const COL_LABEL: Record<ColKey | 'project', string> = {
  ...
  branches: 'Branch', views: 'View', project: 'Project',
}

const SCALAR_LABEL: Record<string, string> = { name: 'name', hierarchyLevels: 'hierarchy levels', settings: 'settings' }
