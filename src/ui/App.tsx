...
function Cheatsheet() {
  ...
  const rows: [string, string][] = [
    ...
    ['Drag a section edge', 'Resize the section (Shift = items inside redistribute)'],
    ['Drag a section label', 'Move the section, its items, and all selected sections'],
    ['Edge-drag multi-selected sections', 'Scale the group proportionally (Shift = items too)'],
